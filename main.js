...
const usernameInput = document.getElementById('user-email-field');
const passwordInput = document.getElementById('password');

// sla de referenties op naar de warning-messages
const usernameWarning = document.getElementById('waarschuwing');
const passwordWarning = document.getElementById('waarschuwing-pass');
